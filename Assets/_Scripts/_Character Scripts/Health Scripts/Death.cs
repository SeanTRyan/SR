...
namespace Characters
{
    ...
    {
        [SerializeField] private uint m_numberOfLives = 2;

        private Animator m_deathAnimator;

        public delegate void DeathDelegate(uint numberOfLives);
        public event DeathDelegate DeathEvent;

        public uint NumberOfLives { get { return m_numberOfLives; } }
